...
r.onload=function(){if('mintpresso' in window){return window["mintpresso"].init(t, o);}else{console.error('Failed to load mintpresso.js (please check http://mintpresso.statuspage.io)')}};
